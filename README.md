...
Там представлены практические кейсы по анализу данных: EDA, расчёт и визуализация метрик, дизайн и анализ результатов A/B-теста, решение ad-hoc задач с помощью SQL-запросов средней сложности.  
