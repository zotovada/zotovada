...
## Обо мне
Я специалист, с которым комфортно работать: умею ясно выражать мысли и договариваться, поддерживать спокойный и уважительный диалог.
...
В данный момент меня интересует продуктовый анализ и автоматизация анализа с помощью ИИ. 
